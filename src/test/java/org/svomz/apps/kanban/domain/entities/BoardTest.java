...
public class BoardTest {
	...
	public void testRemoveStage() throws StageNotInProcessException, StageNotEmptyException {
		...
		try {
			...
			throw e;
		} catch (StageNotEmptyException e) {
			throw e;
		}
		Assert.assertTrue(board.getStages().isEmpty());
	}
	...
	public void testRemoveStageFailWithStageNotInProcessException() throws StageNotInProcessException, StageNotEmptyException {
		Board board = new Board("todo");
	...
	public void testRemoveStageFailWithStageNotEmptyException() throws StageNotInProcessException, StageNotEmptyException {
		Board board = new Board("todo");
	...
	@Test(expected = WorkItemNotOnBoardException.class)
	public void testMovePostItFailWithPostItNotFound() throws WorkItemNotOnBoardException, StageNotInProcessException {
		Board board = new Board("todo");
