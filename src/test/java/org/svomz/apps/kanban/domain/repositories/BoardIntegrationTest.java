...
public class BoardIntegrationTest {
  ...
  @Test
  public void testAddAndRemoveStageAndWorkItem() throws StageNotInProcessException, WorkItemNotOnBoardException, EntityNotFoundException, StageNotEmptyException {
    Board board = new Board("todo");
  ...
  @Test
  public void testMoveWorkItem() throws StageNotInProcessException, WorkItemNotOnBoardException, EntityNotFoundException, StageNotEmptyException {
    Board board = new Board("todo");
    WorkItem postIt = new WorkItem("My first task");
